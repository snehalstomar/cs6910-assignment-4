...
training_data_path = '/content/drive/My Drive/rbm_gibbs/data/fashion-mnist_train.csv'
test_data_path = '/content/drive/My Drive/rbm_gibbs/data/fashion-mnist_test.csv'
