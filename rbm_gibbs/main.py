...
validation_data, training_data, test_data, validation_labels, train_labels, test_labels = data_reader.rbm_data_reader(training_data_path, test_data_path, 0.1, 127)
...
def train_and_evaluate(num_hidden_nodes, num_markov_chain_iterations, num_samples_extracted, rbm_training_epochs):
	...
	rbm_gibbs = rbm.rbm(train_data.shape[1], num_hidden_nodes)
	rbm_gibbs.train_gibbs(train_data, num_markov_chain_iterations, num_samples_extracted, rbm_training_epochs, 0.01)
